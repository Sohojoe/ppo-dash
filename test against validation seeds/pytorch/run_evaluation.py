...
def main():
    ...
    if args.exp_name == 'debug':
        # args.exp_name = 'presub164' # 8.6 after 5
        # args.exp_name = 'presub163' # 9.0 
        # args.exp_name = 'presub162' # 8.6 after 5
        args.exp_name = 'presub161' # 10 after 5, demo = 9.8
        # args.exp_name = 'presub160' # 10 after 5, demo=8.0
        args.env = 'ObtRetro-v7'
    ...
    while True:
        ...
        if done:
            ...
            episode_reward = 0
            max_level = 0
            if is_grading(env.unwrapped.envs[0]):
                if done_grading(env.unwrapped.envs[0]):
                    break
